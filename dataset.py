...
class DataCleaningPipeline:
    ...
    def __init__(self) -> None:
        self.raw_text = self.load_raw_enwik8()

    def load_clean_enwik8(self) -> str:
    ...
    def clean_text(self) -> None:
        ...
        prefixes.add('*') # The * removes the bullet points, might be bad but most are useless
...
if __name__ == '__main__':
    ...
    length_original = len(dcp.raw_text)
